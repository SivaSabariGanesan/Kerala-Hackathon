...
import { ArrowLeft, Package, Truck, CheckCircle, MapPin, CreditCard, ShoppingBag } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="border-b border-gray-100 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${orderStatuses[order.status].color}`}>
                {orderStatuses[order.status].icon}
                <span className="text-sm font-medium">{orderStatuses[order.status].description}</span>
              </div>
            </div>
          </div>
